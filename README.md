...
**PyOSPA2** is a Python library with C++ backend implementing the
**OSPA(2) metric for multi-target tracking**, based on:
* **OSPA(2): Using the OSPA metric to evaluate multi-target tracking performance** Michael Beard; Ba Tuong Vo; Ba-Ngu Vo
